...
var education = {
    ...
    display: function() {
        ...
        this.schools.forEach(function(ele) {
            $('.education-entry').append(HTMLschoolName.replace('%data%', ele.name).replace('#', ele.url) + HTMLschoolDegree.replace('%data%', ele.degree),
        ...
        this.onlineCourses.forEach(function(ele) {
            $('.education-entry:eq(1)').append(HTMLonlineTitle.replace('%data%', ele.title).replace('#', ele.url) + HTMLonlineSchool.replace('%data%', ele.school),
...
var work = {
    ...
    display: function() {
        ...
        this.jobs.forEach(function(ele, index) {
            $('.work-entry').append(HTMLworkEmployer.replace('%data%', ele.employer) + HTMLworkTitle.replace('%data%', ele.title),
